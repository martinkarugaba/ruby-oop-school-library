...
**[School_Library]** is an app that is built to show the basics of how OOP works in ruby.
...
- **[A_class_for_people]**
- **[A_class_for_students]**
- **[A_class_for_teachers]**
...
```sh
  cd my-folder
  git clone git@github.com:martinkarugaba/ruby-oop-school-library.git
```
--->
...
I would like to thank Microverse for guiding me while building this project.
